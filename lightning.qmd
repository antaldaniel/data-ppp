...
format: html
url: https://reprex.nl/event/2024-02-20_idcc24/
editor: visual
bibliography: 
 - bib/dataspace.bib
---
...
2. The *now* published music works's author will get a VIAF entry, because as the work is officially published, at one point it should appear in a public library or repository, even if we do not know yet where. 

## Dataspace model
![](images/Slide5.PNG){fig-align="center"}

We are following the dataspace models that had been recommended by several working groups in the past years, for example, the EBU [@dataspace_for_cci_2022]. We also heavily borrow on the work popularised by the EU Open Data portal with the use of Wikibase an identity brokerage and content negotiation tool.
