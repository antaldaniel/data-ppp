...
![](png/idcc24/Slide4.PNG){fig-align="center"}
...
![](png/idcc24/Slide5.PNG){fig-align="center"}

We are following the dataspace models that had been recommended by several working groups in the past years, for example, the EBU [@dataspace_for_cci_2022]. We also heavily borrow on the work popularised by the EU Open Data portal with the use of Wikibase an identity brokerage and content negotiation tool. (See also [@design_principles_data_spaces_2021].) We are very much indebted to the groundbreaking work of the Luxembourg Shared Authority File, but we want to go further, and include statistical agencies and private parties into the data sharing, which requires a more thorough understanding of potential conflicts of interests, shared interests, and different data jurisdictions.
...
![](`png/idcc24/Slide6.PNG){fig-align="center"}
